...
Section "Install"
  ...
  CreateShortCut "$SMPROGRAMS\${APP_NAME}\${APP_NAME} (debug).lnk" \
    "$INSTDIR\2x2-Wallet-Debug.cmd"
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\${APP_NAME}\${APP_NAME} (debug).lnk"
